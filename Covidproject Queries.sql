...
-- Shows likelihood of dying if you contract covid in the US (at a certain date)
...
-- US Deaths and Death Percentage 
...
Select location, MAX(cast(people_fully_vaccinated as bigint)) as PeopleVaccinated, population, Max(cast(people_fully_vaccinated as bigint))/population*100 as PercentageVaccinated
...
-- new cases / vaccines as a time series 
